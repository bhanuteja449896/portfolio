...
function TechIKnow() {
  ...
  const techs = [
    ...
    },
    {
      ...
      image: firebase,
      description:
        "Firebase is a Backend-as-a-Service (BaaS) platform provided by Google that enables developers to build web and mobile applications without the need to set up and manage server infrastructure. It provides a range of tools and services for building, testing, and deploying applications, including real-time database, cloud storage, authentication, hosting, and more.",
    },
    {
      title: "GitHub",
      image: github,
      description:
        "Git is a distributed version control system that is widely used by developers to manage and track changes to code and other files. It allows multiple developers to work on the same project simultaneously and makes it easy to track changes, collaborate, and maintain different versions of code.",
    },
    {
      title: "Angular",
      image: angular,
  ...
  return (
    <div
      style={{
        ...
        paddingLeft: width <= 720 ? 20 : 30,
        paddingRight: width <= 720 ? 20 : 90,
        paddingTop: 20,
        paddingBottom: 20,
      }}
    >
